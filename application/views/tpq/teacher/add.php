    ...
    <div class="box box-success">
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Kategori Pengajar</label>
              <select class="form-control" style="width: 100%;" id="teacher_category">
                <option value="MT">Mubalegh Tugas</option>
                <option value="MS">Mubalegh Setempat</option>
