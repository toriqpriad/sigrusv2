...
class position extends admin
{
    ...
    public function post()
    {
        ...
        $position_id = $add["data"];

        if ($add) {
            $data = array("link" => base_url() . 'admin/position/' . $position_id);
            $result = get_success($data);
        } else {
            $params = new stdClass();
            $params->response =  NO_DATA_STATUS;
            $params->message = FAIL_STATUS;
            $params->data = array("error" => $error_data, "link" => base_url() . 'admin/position/' . $position_id);
    ...
    public function detail()
    {
        ...
        $params = new stdClass();
        $params->dest_table_as = 'position as p';
        $params->select_values = array('p.*');
    ...
    public function update()
    {
        ...
        $params = new stdClass();
        $params->dest_table_as = 'position as g';
        ...
        if ($update['response'] == OK_STATUS) {
            ...
            $params->data = array('link' => base_url() . 'admin/position/' . $id);
            $result = response_custom($params);
        } else {
