...
|
*/
$base_url ="http://".$_SERVER['HTTP_HOST']."/sigrus/";
...
define('TPQ_WEBAPP_URL', BASE_URL . "tpq/");
define('ASSETS_STATIC', BASE_URL . 'assets/statics/');
define('BACKEND_STATIC_FILES', BASE_URL . 'assets/statics/backend/adminlte/');
...
define('SERVER_SECRET_KEY', 'sigrus354313');
...
// define('MAIN_EMAIL', "sigrus.2016@gmail.com");
// define('MAIN_EMAIL_PASSWORD', "cariajadigoogle123");
// define('MAIN_EMAIL_NAME', "sigrus Administrator");
// define('EMAIL_SUBJECT_GUIDE_REGISTRATION_VERIFICATION', "sigrus New Guide Registration");
